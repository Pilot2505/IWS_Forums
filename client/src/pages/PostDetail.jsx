    ...
    return (
      <div
        className={`rounded-2xl p-4 transition ${
          replyTo === c.id ? "bg-forum-primarySoft/30" : "bg-transparent"
        }`}
      >
          ...
          <div className="flex-1">
            ...
            {(c.user_id === user.id || post.user_id === user.id) && (
              <button
                ...
                className="ml-3 text-sm font-medium text-forum-danger"
              >
                Delete
              </button>
            )}
      ...
      <main className="mx-auto flex max-w-content flex-col gap-6 px-4 py-6 sm:px-6 lg:flex-row lg:items-start lg:px-10 lg:py-10">
              ...
              <div className="flex-1 space-y-5">
                ...
                <div className="flex flex-col gap-3 pt-2 sm:flex-row sm:justify-end">
                  ...
                  <button
                    ...
                    className="inline-flex h-12 items-center justify-center rounded-2xl bg-forum-primary px-5 font-medium text-white transition hover:bg-forum-primaryDark disabled:cursor-not-allowed disabled:opacity-70"
                  >
                    Save
                  </button>
                </div>
            ...
            {post.user_id === user.id && !isEditing && (
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className="rounded-2xl border border-forum-danger/20 bg-forum-dangerSoft px-4 py-2 text-sm font-semibold text-forum-danger"
                >
                  Delete
                </button>
              </div>
        ...
        <aside className="w-full lg:sticky lg:top-28 lg:w-[380px] lg:flex-shrink-0">
          <div className="rounded-[28px] border border-forum-border bg-forum-surface p-5 shadow-panel sm:p-6">
            ...
            {/* Auto-styled: threaded replies and moderation actions are inferred because Figma only shows a flatter response list. */}
      ...
      {showDeleteDialog && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-slate-950/55 px-4 py-6 sm:items-center">
          <div className="w-full max-w-md rounded-[28px] border border-forum-border bg-forum-surface shadow-dialog">
            <div className="flex items-start gap-4 border-b border-forum-border px-6 py-5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm leading-6 text-forum-muted">
                  This action permanently removes the post and its discussion
                  from the feed.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 px-6 py-5 sm:flex-row sm:justify-end">
              ...
              <button
                ...
                className="inline-flex h-12 items-center justify-center rounded-2xl bg-forum-danger px-5 font-medium text-white transition hover:bg-red-700"
              >
                Delete
              </button>
            </div>
