...
router.get("/following/:userId", auth, validate(followCountSchema), getFollowingUsers); // Get list of users that the signed-in user is following
router.get("/followers/:userId", auth, validate(followCountSchema), getFollowersUsers); // Get list of users that follow the signed-in user
router.get("/:userId", auth, validate(followCountSchema), getFollowingUsers); // Backward-compatible alias for following list
